...
exports.datesContainer = exports.metaData = void 0;
exports.metaData = {
    title: 'England NHS Timeline'
};
exports.datesContainer = [
    {
        year: '1943',
        image_src: '/media/colossus-computer.jpg',
        alt_text: 'Colossus computer',
        header: 'Colossus computer',
        content: 'The first electronic computer. Used as a codebreaker in World War II.',
    ...
    },
    {
        ...
        content: 'Dr Arthur Rappoport uses the McBee Manual Punch Card in pathology labs.',
    ...
    },
    {
        ...
        alt_text: 'Another description',
        header: 'EMIS',
        content: 'A GP in the village of Egton in Yorkshire, persuaded IBM to give him a computer and a suitable programme, built a room onto his surgery to house it and created Egton Medical Information Systems (EMIS)',
    ...
    },
    {
        ...
        alt_text: 'Another description',
        header: 'Read codes',
        content: 'Dr Read, a GP in Leicestershire, realised a dictionary of medical diagnoses was needed for his computer system and set out to create it, initially using the death certification lists described above and started with a few thousand codes.'
    },
    {
        year: '...',
    ...
    },
    {
        ...
        content: 'In 1989, British scientist Tim Berners-Lee created the World Wide Web (WWW) while working at CERN. His intention was to develop a system that would enable automated sharing of information among scientists across universities and research institutions globally.'
    },
    {
        year: '1992',
        ...
        content: 'Information will be person-based. Information should focus on health. Systems should be integrated. Information will be derived from operational systems. Information will be secure and confidential. Information will be shared across the NHS'
    },
    {
        year: '1997',
...
Principle 6: comply with the law.`
    },
    {
        ...
        header: 'Wanless',
        content: 'We have achieved less because we have spent very much less and not spent it well.'
    },
    {
        year: '2002',
...
Very little in terms of deliveries - mainly PACS (picture archiving and communication system)`
    },
    {
        ...
        alt_text: 'Front cover of Wachter Review with net connectivity like structure',
...
This mixed use case has complications in English law.`
    },
    {
        ...
        image_src: '/media/fci-logo.png',
        alt_text: 'Another description',
        header: 'Faculty of Clinical Informatics absorbed into British Computer Society',
