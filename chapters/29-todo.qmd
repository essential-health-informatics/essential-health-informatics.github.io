...
- Student and seasoned professional content access/switch.
- Single image added to the front matter of each chapter with alt and verticalPosition. This then is used to create the banner in a 3:1 ratio.
